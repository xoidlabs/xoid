    ...
    const getAddress = (store, obj, actionAddress) => {
        ...
        return new Proxy(obj, {
            ...
            apply(target, thisArg, args) {
                ...
                store[META].root.devtoolsChannel.notify(Object.assign(Object.assign({}, action), { args }));
                const result = Reflect.apply(target, thisArg, args);
                if (isAsync)
                    result.then(() => store[META].root.devtoolsChannel.notify(Object.assign(Object.assign({}, action), { end: true })));
                else
