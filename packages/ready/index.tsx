...
var createCell = function (parentMeta, key) {
    if (Object.prototype.hasOwnProperty.call(parentMeta.cache, key))
        return parentMeta.cache[key];
    var root = parentMeta.root;
    var shape = parentMeta.shape && (parentMeta.shape[key] || parentMeta.shape[RECORD]);
    var address = parentMeta.address ? Object.assign([], parentMeta.address) : [];
    address.push(key);
    var meta = {
        ...
        set node(value) {
            if (root.mutable) {
                ...
                var copy = shallowClone(parentMeta.node);
                copy[key] = value;
